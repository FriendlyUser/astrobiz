...
const MainFeatures = () => {
 ...
 <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" strokeWidth="2" className="w-10 h-10" viewBox="0 0 24 24">
 ...
 <img alt="feature" className="object-cover object-center h-full w-full" src="./nature_3.jpeg" />
 </div>
 </div>
